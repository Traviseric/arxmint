...
// ============================================================
// ArxMint — Merchant Pledge Form
// Public signup for businesses pledging to accept Bitcoin
// when the network goes live. No auth required.
// ============================================================
...
export function MerchantPledgeForm({ onSuccess }: PledgeFormProps) {
    ...
    return (
      <div className="bg-bg-elevated border border-accent/30 rounded-xl p-8 text-center">
        ...
        <p className="text-text-secondary max-w-md mx-auto">
          <span className="text-text-primary font-medium">{businessName}</span> has been
          added to the ArxMint merchant pledge list. We&apos;ll notify you when
          the network is ready for onboarding.
        </p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        ...
        <label className="flex items-center gap-2 mt-3 cursor-pointer select-none">
          ...
          <span className="text-xs text-text-secondary">
            Notify me when the network launches
          </span>
        </label>
      </div>
      ...
      <div>
        ...
        />
        <p className="text-xs text-text-muted mt-1">
          {reason.length}/500 — shown publicly on the pledge board.
        </p>
      </div>
