...
claude --dangerously-skip-permissions --model sonnet 2>"C:\\code\\te-btc\\arxmint\\.overnight\\worker_002_managed_stderr.log"
...
if exist "C:\\code\\te-btc\\arxmint\\.overnight\\worker_002_managed_stderr.log" (
    findstr /i /c:"hit your limit" /c:"rate-limit" /c:"resets" "C:\\code\\te-btc\\arxmint\\.overnight\\worker_002_managed_stderr.log" >nul 2>&1
    if not errorlevel 1 (
        echo MANAGED WORKER RATE LIMITED - see C:\\code\\te-btc\\arxmint\\.overnight\\worker_002_managed_stderr.log
    )
)
