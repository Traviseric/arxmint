...
OVERNIGHT_TASKS_PATH: C:\code\te-btc\arxmint\OVERNIGHT_TASKS.md
...
**Write a "## Next Session Work" section** to `C:\code\te-btc\arxmint\OVERNIGHT_TASKS.md`:
...
Write to: C:\code\te-btc\arxmint\.overnight\digest_output.json
