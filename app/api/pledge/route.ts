...
const SEED_MERCHANTS = [
  ...
  // ── TE Code Ecosystem Merchants ──
  {
    id: "seed-image-engine",
    businessName: "Image Engine",
    location: "Fort Collins, CO",
    category: "technology",
    website: "https://image-engine.app",
    logoUrl: "/images/merchants/image-engine.png",
    reason:
      "AI image generation for book covers, logos, avatars, and marketing campaigns. Pay per image with Lightning — turbo, standard, or quality tiers. No subscriptions required.",
    featured: false,
  ...
  {
    id: "seed-conversos",
    businessName: "Conversos",
    location: "Fort Collins, CO",
    category: "technology",
    website: "https://conversos.app",
    logoUrl: "/images/merchants/conversos.png",
    reason:
      "AI chat intelligence with personality-aware routing. Drop-in conversational widget for any website. Pay per session or monthly — agents and humans use the same Lightning rails.",
    featured: false,
    createdAt: new Date("2025-02-03").toISOString(),
    checkoutEnabled: true,
    defaultAmountSats: 100,
  },
  {
    id: "seed-profileengine",
    businessName: "ProfileEngine",
    location: "Fort Collins, CO",
    category: "technology",
    website: "https://profileengine.app",
    logoUrl: "/images/merchants/profileengine.png",
    reason:
      "5-layer psychological analysis from text. AI personality profiling for HR, sales, and customer intelligence. Pay per analysis with Lightning.",
    featured: false,
  ...
  {
    id: "seed-trendos",
    businessName: "TrendOS",
    location: "Fort Collins, CO",
    category: "technology",
    website: "https://trend-os.io",
    logoUrl: "/images/merchants/trendos.png",
    reason:
      "AI trend intelligence — keyword research, grant discovery, and opportunity alerts. Pay per report or subscribe for daily alerts. Lightning-native from day one.",
    featured: false,
  ...
  {
    id: "seed-marketingos",
    businessName: "MarketingOS",
    location: "Fort Collins, CO",
    category: "technology",
    website: "https://marketingos.app",
    logoUrl: "/images/merchants/marketingos.png",
    reason:
      "AI marketing automation — email campaigns, social calendars, lead scoring, and GTM strategy. Pay per campaign with Lightning.",
    featured: false,
    createdAt: new Date("2025-02-10").toISOString(),
    checkoutEnabled: true,
    defaultAmountSats: 2000,
  },
  {
    id: "seed-analyticsos",
    businessName: "AnalyticsOS",
    location: "Fort Collins, CO",
    category: "technology",
    website: "https://analyticsos.io",
    logoUrl: "/images/merchants/analyticsos.png",
    reason:
      "Behavioral web analytics with bot detection. Feature flags, A/B testing, and real-time visitor intelligence. Pay per report or monthly access via Lightning.",
    featured: false,
  ...
  {
    id: "seed-detection-lab",
    businessName: "Detection Lab",
    location: "Fort Collins, CO",
    category: "technology",
    website: "https://detectionlab.app",
    logoUrl: "/images/merchants/detection-lab.png",
    reason:
      "25-signal behavioral biometrics and bot detection scoring engine. Security research grade. Pay per scoring session with Lightning.",
    featured: false,
    createdAt: new Date("2025-02-14").toISOString(),
    checkoutEnabled: true,
    defaultAmountSats: 5000,
  },
  {
    id: "seed-formforge",
    businessName: "FormForge",
    location: "Fort Collins, CO",
    category: "technology",
    website: "https://formforge.app",
    logoUrl: "/images/merchants/formforge.png",
    reason:
      "Drop-in form API with AI spam detection. Multi-tenant form hosting, email delivery, and submission management. Pay per form or monthly hosting via Lightning.",
    featured: false,
  ...
  {
    id: "seed-domainos",
    businessName: "DomainOS",
    location: "Fort Collins, CO",
    category: "technology",
    website: "https://domainos.app",
    logoUrl: "/images/merchants/domainos.png",
    reason:
      "AI domain intelligence — search, valuation, trademark checking, and brand name generation. Natural language domain discovery. Pay per search with Lightning.",
    featured: false,
  ...
  {
    id: "seed-faviforge",
    businessName: "FaviForge",
    location: "Fort Collins, CO",
    category: "technology",
    website: "https://faviforge.app",
    logoUrl: "/images/merchants/faviforge.png",
    reason:
      "AI favicon generator with iterative self-correction. Individual icons or complete favicon sets for every platform. Pay per icon with Lightning.",
    featured: false,
    createdAt: new Date("2025-02-20").toISOString(),
    checkoutEnabled: true,
    defaultAmountSats: 200,
  },
  {
    id: "seed-video-engine",
    businessName: "Video Engine",
    location: "Fort Collins, CO",
    category: "entertainment",
    website: "https://video-engine.app",
    logoUrl: "/images/merchants/video-engine.png",
    reason:
      "12-stage AI video production pipeline. Short clips, ads, and full campaign packages with Blender integration. Pay per video with Lightning.",
    featured: false,
  ...
  {
    id: "seed-audio-engine",
    businessName: "Audio Engine",
    location: "Fort Collins, CO",
    category: "entertainment",
    website: "https://audio-engine.app",
    logoUrl: "/images/merchants/audio-engine.png",
    reason:
      "AI audio production — voiceovers, podcast editing, and music production. 10-stage artist release pipeline with Suno V5 and ElevenLabs. Pay per clip with Lightning.",
    featured: false,
  ...
  {
    id: "seed-revenue-engine",
    businessName: "RevenueEngine",
    location: "Fort Collins, CO",
    category: "technology",
    website: "https://revenueengine.app",
    logoUrl: "/images/merchants/revenue-engine.png",
    reason:
      "Cross-service revenue intelligence and orchestration. UltraThink analysis, MCP services, and multi-project billing. Pay per analysis or monthly access via Lightning.",
    featured: false,
