        ...
        <nav className="fixed top-0 w-full z-50 border-b border-border-default glass-heavy">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              <a href="/why" className="text-sm text-text-secondary hover:text-text-primary transition-colors">
                Why
              </a>
              <a href="/agents" className="text-sm text-text-secondary hover:text-text-primary transition-colors">
                Agents
              </a>
              ...
              <a href="/create" className="antigravity-btn !px-4 !py-2 !text-sm">
                Get Started
              </a>
            </div>
          </div>
