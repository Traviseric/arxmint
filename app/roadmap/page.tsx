...
const phases: RoadmapPhase[] = [
  ...
  },
  {
    ...
    icon: Store,
    description:
      "A self-hosted, non-custodial Stripe alternative. Merchants run their own payment node. One Docker command, one script tag, done. Legally protected as open-source software — ArxMint never touches funds.",
    ...
    tasks: [
      ...
      {
        id: "5.8",
        title: "One-command merchant deploy",
        humanTitle: "One Docker command — your payment node is live",
        description: "arxmint merchant init → generates Docker Compose with LND + Cashu mint + checkout + dashboard + Caddy HTTPS. VPS one-liner install. Cloud deploy buttons for DigitalOcean, Vultr, LunaNode.",
        status: "pending" as const,
      },
      {
        id: "5.9",
